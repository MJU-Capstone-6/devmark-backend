    ...
    "paths": {
        ...
        "/api/v1/comment": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "comment param",
                        "name": "param",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateCommentParam"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateCommentParam"
                        }
                    },
                    {
                        "type": "integer",
