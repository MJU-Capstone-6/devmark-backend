...
func (_m *IWorkspaceService) Create(_a0 string) (*repository.Workspace, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*repository.Workspace, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(string) *repository.Workspace); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
