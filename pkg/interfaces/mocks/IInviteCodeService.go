...
func (_m *IInviteCodeService) CreateInviteCode(_a0 request.CreateInviteCodeParam) (*repository.InviteCode, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(request.CreateInviteCodeParam) (*repository.InviteCode, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(request.CreateInviteCodeParam) *repository.InviteCode); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(request.CreateInviteCodeParam) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
