...
// FindJoinedWorkspace provides a mock function with given fields: _a0
func (_m *IUserService) FindJoinedWorkspace(_a0 int) (*repository.UserWorkspaceView, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for FindJoinedWorkspace")
	}

	var r0 *repository.UserWorkspaceView
	var r1 error
	if rf, ok := ret.Get(0).(func(int) (*repository.UserWorkspaceView, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(int) *repository.UserWorkspaceView); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
// FindUnreadBookmarks provides a mock function with given fields: _a0
func (_m *IUserService) FindUnreadBookmarks(_a0 int) (*[]repository.FindUnreadBookmarkRow, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for FindUnreadBookmarks")
	}

	var r0 *[]repository.FindUnreadBookmarkRow
	var r1 error
	if rf, ok := ret.Get(0).(func(int) (*[]repository.FindUnreadBookmarkRow, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(int) *[]repository.FindUnreadBookmarkRow); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *IUserService) FindUserById(_a0 int) (*repository.FindUserByIdRow, error) {
	ret := _m.Called(_a0)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(int) (*repository.FindUserByIdRow, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(int) *repository.FindUserByIdRow); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
